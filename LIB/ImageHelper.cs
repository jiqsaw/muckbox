...
namespace LIB
{
    public class ImageHelper
    {
        ...
        public void Resize(System.Drawing.Image image, string SavePath, int W)
        {
        ...
        public void Crop(string PhotoPath, string SavePath, int W, int H, bool Resizing)
        {
            ...
            Crop(img, SavePath, W, H, Resizing);

        }

        public void Crop(System.Drawing.Image image, string SavePath, int W, int H, bool Resizing)
        {
            System.Drawing.Image img = image;
