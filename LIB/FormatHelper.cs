...
namespace LIB
{
    public sealed class FormatHelper
    {
        ...
        public static string FileName(string fileName, char? replacement = null, bool addRandomValue = false)
        {
            ...
            if (addRandomValue)
                str = str.Insert(str.LastIndexOf('.'), "_" + LIB.Util.RandomNumber(99));
