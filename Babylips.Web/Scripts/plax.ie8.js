/* Plax version 1.3.1 2011 Cameron McEfee */
(function ($) {
    ...
    function plaxifier(e) {
        ...
        for (i = layers.length; i--;) {
            ...
            if (layer.background) {
                ...
                layer.obj[0].style.background = Math.floor(newX) + 'px' // Better performance
            } else {
                //layer.obj.css('left', newX).css('top', newY)
                layer.obj[0].style.left = Math.floor(newX) + 'px'; // Better performance
                layer.obj[0].style.top = Math.floor(newY) + 'px';
            }
        }
    }
...
})(function () { return typeof jQuery !== 'undefined' ? jQuery : ender }());
